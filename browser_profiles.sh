pro_def_src="/home/maruti/.config/google-chrome/Default/History"
...
date=$(date +"%m%d%y")
cp $pro_def_src $pro_dst_path/'PDHistory_'$date
cp $pro_1_src $pro_dst_path/'P1History_'$date
cp $pro_2_src $pro_dst_path/'P2History_'$date
# path_src=./folder1
# path_dst=./folder2
# date=$(date +"%m%d%y")
